...
* __App.js__ (Context Provider)
    ...
    * __LanguageContext.js__ the structure of the context file that gets imported where is necesary; gets _"lang"_ the _"setLang"_ callback prop from the __App.js__
